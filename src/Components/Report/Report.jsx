        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.columnMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.columnMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.beamMoisture && (
              <div className={style.direction}>
                Rate of Moisture:{info.groundFloor?.detail?.beamMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.slabMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.slabMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.lintelMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.lintelMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.balconyMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.balconyMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.exWallMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.exWallMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.inWallMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.inWallMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.flooringMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.flooringMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.doorWinMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.doorWinMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.stairSlabMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.stairSlabMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.stairStepMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.stairStepMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.stairRailMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.stairRailMoisture}
              </div>
            )}
        ...
        <div className={style.imgData}>
          ...
          <div className={style.lContent}>
            {info.groundFloor?.detail?.passageMoisture && (
              <div className={style.direction}>
                Rate of Moisture: {info.groundFloor?.detail?.passageMoisture}
              </div>
            )}
          ...
          <div className={style.item} key={index}>
            ...
            <div className={style.imgData}>
              ...
              <div className={style.lContent}>
                {item.columnMoisture && (
                  <div className={style.direction}>
                    Rate of Moisture: {item.columnMoisture}
                  </div>
                )}
                {item.columnRemark && (
            ...
            <div className={style.imgData}>
              ...
              <div className={style.lContent}>
                {item.beamMoisture && (
                  <div className={style.direction}>
                    Rate of Moisture:{item.beamMoisture}
                  </div>
                )}
                {item.beamRemark && (
            ...
            <div className={style.imgData}>
              ...
              <div className={style.lContent}>
                {item.slabMoisture && (
                  <div className={style.direction}>
                    Rate of Moisture:{item.slabMoisture}
                  </div>
                )}
                {item.slabRemark && (
            ...
            {item.lintelImg && <div className={style.title}>Lintel/Chajja</div>}
            <div className={style.imgData}>
              <div className={style.rContent}>
              ...
              <div className={style.lContent}>
                {item.lintelMoisture && (
                  <div className={style.direction}>
                    Rate of Moisture:{item.lintelMoisture}
                  </div>
                )}
                {item.lintelRemark && (
            ...
            <div className={style.imgData}>
              ...
              <div className={style.lContent}>
                {item.balconyMoisture && (
                  <div className={style.direction}>
                    Rate of Moisture:{item.balconyMoisture}
                  </div>
                )}
                {item.balconyRemark && (
            ...
            {item.exWallImg && <div className={style.title}>External wall</div>}
            <div className={style.imgData}>
              <div className={style.rContent}>
              ...
              <div className={style.lContent}>
                {item.exWallMoisture && (
                  <div className={style.direction}>
                    Rate of Moisture:{item.exWallMoisture}
                  </div>
                )}
                {item.exWallRemark && (
            ...
            {item.inWallImg && <div className={style.title}>Internal wall</div>}
            <div className={style.imgData}>
              <div className={style.rContent}>
              ...
              <div className={style.lContent}>
                {item.inWallMoisture && (
                  <div className={style.direction}>
                    Rate of Moisture:{item.inWallMoisture}
                  </div>
                )}
                {item.inWallRemark && (
            ...
            <div className={style.imgData}>
              ...
              <div className={style.lContent}>
                {item.doorWinMoisture && (
                  <div className={style.direction}>
                    Rate of Moisture:{item.doorWinMoisture}
                  </div>
                )}
                {item.doorWinRemark && (
            ...
            <div className={style.imgData}>
              ...
              <div className={style.lContent}>
                ...
                {item.stairSlabRemark && (
                  <div className={style.direction}>{item.stairSlabRemark}</div>
                )}
              </div>
            </div>
            ...
            <div className={style.imgData}>
              ...
              <div className={style.lContent}>
                ...
                {item.stairStepRemark && (
                  <div className={style.direction}>{item.stairStepRemark}</div>
                )}
              </div>
            </div>
            ...
            <div className={style.imgData}>
              ...
              <div className={style.lContent}>
                ...
                {item.stairRailRemark && (
                  <div className={style.direction}>{item.stairRailRemark}</div>
                )}
              </div>
            </div>
            ...
            <div className={style.imgData}>
              ...
              <div className={style.lContent}>
                {item.passageMoisture && (
                  <div className={style.direction}>
                    Rate of Moisture:{item.passageMoisture}
                  </div>
                )}
                {item.passageRemark && (
    ...
    return (
      <div className={style.container}>
        ...
        {info.foundationInfo?.detail?.condition && (
          <>
          <label className={style.title}>Surrounding soil/water condition</label>
